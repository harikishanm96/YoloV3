...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--cfg", type=str, default="./cfg/yolov3-custom.cfg", help="*.cfg path"
    )
    parser.add_argument(
        "--data", type=str, default="./data/customdata/custom.data", help="*.data path"
    )
    parser.add_argument(
        "--multi-scale",
        action="store_true",
